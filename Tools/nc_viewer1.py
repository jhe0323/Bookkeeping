...
3. 支持 bbox 子区
4. 支持保存图片
python nc_viewer.py summary_global_4.16.nc --list
python nc_viewer.py summary_global_4.16.nc --var atmosphere --year 1900
python nc_viewer.py summary_global_4.16.nc --var atmosphere --diff-index 10 9
python nc_viewer.py summary_global_4.16.nc --var atmosphere --diff-year 1900 1899
"""
