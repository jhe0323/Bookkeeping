...
#DSUB -n mc_1deg_s__SAMPLE_PAD___b__BAND_PAD__
#DSUB -A root.xibnlkjdxstbckxygcxyuan
#DSUB -q root.default
#DSUB -N 1
#DSUB -R cpu=1
#DSUB -oo /home/xibnlkjdxstbckxygcxyuan/jzh0126/LULCC/logs/mc_1deg_s__SAMPLE_PAD___b__BAND_PAD___%J.out
#DSUB -eo /home/xibnlkjdxstbckxygcxyuan/jzh0126/LULCC/logs/mc_1deg_s__SAMPLE_PAD___b__BAND_PAD___%J.err
...
python --version
echo "Resolution: 1deg"
echo "MC_SAMPLE_ID=${MC_SAMPLE_ID}"
echo "BAND_ID=${BAND_ID} / 35"
