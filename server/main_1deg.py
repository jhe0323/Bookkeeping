#!/usr/bin/env python3
# -*- coding: UTF-8 -*-
"""Run a 1° longitude-band bookkeeping simulation on the server."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run one 1° longitude band on the server."
    )
    parser.add_argument(
        "--experiment",
    ...
    parser.add_argument("--state-file", default="states_1deg.nc")
    parser.add_argument("--transition-file", default="transitions_1deg.nc")
    parser.add_argument("--pft-file", default="IBIS_PFT_dominant_1deg.nc")
...
def main() -> None:
    ...
    out_dir = OUT_ROOT / "1deg" / exp_name
    out_dir.mkdir(parents=True, exist_ok=True)
    out_nc = out_dir / f"summary_1deg.rank{band_id:03d}.nc"
